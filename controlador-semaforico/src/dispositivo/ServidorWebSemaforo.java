...
public class ServidorWebSemaforo {
    ...
    public ServidorWebSemaforo(int puerto, Map<String, String> estadosSemaforos) {
        this.puerto = puerto;
    ...
    class ManejadorDeFicheros implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            try {
                ...
                respuestaHtml = new String(Files.readAllBytes(Paths.get("controlador-semaforico/index.html")));
