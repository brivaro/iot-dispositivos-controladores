...
public class DispositivoIniciador {
	...
	public static void main(String[] args) {
		...
		if ( args.length < 4 ) {
			...
			System.out.println("Example: java -jar dispositivo.jar ttmi050 ttmi050.iot.upv.es 8182 tcp://tambori.dsic.upv.es:10083");
			return; //  ttmi050 ttmi050.iot.upv.es 8182 tcp://tambori.dsic.upv.es:10083
		}
